...
router.post('/rating', verify.token, async (req, res) => {
	let { movieId, rating, review, subprofileId } = req.body
...
router.delete('/rating', verify.token, async (req, res) => {
	let { movieId, subprofileId } = req.body
...
router.post('/addLog', verify.token, async (req, res) => {
	const { movieId, referer, videoId, endTime, startTime, action, subprofileId } = req.body
